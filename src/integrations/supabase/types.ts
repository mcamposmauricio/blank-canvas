...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      chat_room_reads: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "chat_room_reads_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      trail_activity_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "trail_activity_logs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "attendant" | "master" | "moderator" | "user"
      timeline_event_type:
        | "meeting"
        | "email"
        | "call"
